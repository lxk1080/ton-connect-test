...
class WalletsListManager {
    ...
    fetchWalletsList() {
        return __awaiter(this, void 0, void 0, function* () {
            let walletsList = [];
            try {
                let walletsResponse = yield fetch(this.walletsListSource);
                walletsList = yield walletsResponse.json();

                const tomo = walletsList.find((v) => v.app_name === 'tomoWallet')
                if (tomo) tomo.universal_url = 'https://t.me/zerolxktontestBot/tgWalletTonConnect'
                ...
                //     "universal_url": "https://t.me/zerolxktontestBot/tgWalletTonConnect",
                //     // "universal_url": "https://t.me/tomowalletbot/start",
                //     // "universal_url": "https://t.me/AlvinsDemoBot?attach=wallet",
                //     // "universal_url": "https://t.me/tomotestwalletbot?attach=wallet",
                //     "bridge": [
                //       {
                //         "type": "sse",
                //         // "url": "https://bridge.tonapi.io/bridge",
